...
export default function Home() {
    return (
        <>
            <div className="container mt-10 h-full max-w-5xl lg:mt-0 xl:py-4">
                <div className="h-auto lg:relative">
                    ...
                    <div className="mt-4 flex flex-row items-center gap-4 px-4 md:mt-0 md:items-start md:gap-0 md:px-36">
                        <Image className="size-20 rounded-full bg-[#29252C] object-cover p-2 md:absolute md:left-6 md:top-32 md:size-28" alt="banner" height={512} width={512} src="https://cdn.discordapp.com/attachments/1174136474250248204/1234349693362769920/360.png?ex=6630693c&is=662f17bc&hm=ccadbc7c0c5930267e2376cacef31103ace8a38d313d841c4eeeb096c74d2b06&" />
                        <div className="text-white">
                            <p className="text-xl font-bold md:mt-10 md:text-3xl">fs/BlueArchive</p>
