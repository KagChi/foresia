...
export default function Home() {
    return (
        <>
            <div className="container flex w-full flex-col p-10 lg:max-w-6xl">
                <div className="flex w-full cursor-pointer flex-col-reverse gap-6 rounded-md p-4  hover:bg-[#12372A40] lg:w-3/4">
                    <div>
