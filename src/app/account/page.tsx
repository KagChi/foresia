...
export const Register = () => <>
    <div className="container flex w-full max-w-3xl flex-col items-center justify-center gap-2 p-10">
        <form action={createAccount} className="flex w-full flex-col gap-4 rounded-md bg-[#1B1B1B] px-6 py-4 text-white">
            <a href="/" className="flex flex-row gap-4 py-2 md:items-center">
                <ChevronLeft size={28} />
            ...
            <button type="submit" className="ml-auto mt-6 flex h-10 min-w-fit flex-row items-center justify-between gap-2 rounded-md bg-[#12372A40] px-4 py-2 text-xs font-bold md:text-base">
                <p>Register Now</p>
            </button>
        </form>
    </div>
